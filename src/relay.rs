...
async fn relay_stream(
    ...
    let mut fanout: StreamFanout = coordinator.open_stream_fanout(
        &start.request_id,
        &start.vector,
        start.initial_floor,
    ...
    while remaining > 0 {
        let event = tokio::select! {
            ...
            message = fanout.next_message(&summaries) => match message {
        ...
        match event {
            ...
            StreamEvent::Message(Some((shard, message))) => match message.payload {
