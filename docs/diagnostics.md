...
grpcurl -plaintext -d '{}' 127.0.0.1:19300 \
  ai.pipestream.search.v1.DiagnosticsService/GetRuntimeKnobs
grpcurl -plaintext -d '{"name":"segment_pruning","value":"false"}' 127.0.0.1:19300 \
  ai.pipestream.search.v1.DiagnosticsService/SetRuntimeKnob
```
...
grpcurl -plaintext -d '{"interval_ms":500}' 127.0.0.1:19291 \
  ai.pipestream.search.v1.DiagnosticsService/StreamMetrics
```
...
grpcurl -plaintext -d '{"shard":7}' 127.0.0.1:19291 \
  ai.pipestream.search.v1.DiagnosticsService/GetShardDiagnostics
```
...
grpcurl -plaintext -d '{"limit":10}' 127.0.0.1:19291 \
  ai.pipestream.search.v1.DiagnosticsService/RecentQueries
```
